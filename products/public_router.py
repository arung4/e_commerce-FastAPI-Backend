...
from .crud import  get_product_by_id , list_public_products, search_products_by_keyword
...
async def list_products(db:Session = Depends(get_db), current_user: User = Depends(get_current_user), 
      ...
      return list_public_products(db, current_user,category, min_price, max_price, sort_by, page, page_size)
...
async def search_products(
    ...
    return search_products_by_keyword(db, current_user, keyword)
