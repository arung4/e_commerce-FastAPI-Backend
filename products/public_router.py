...
from .crud import  get_product_by_id_public , list_public_products, search_products_by_keyword
...
async def list_products(db:Session = Depends(get_db), 
      ...
      return list_public_products(db,category, min_price, max_price, sort_by, page, page_size)
